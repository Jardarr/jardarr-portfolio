			...
			<div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
				<div className="flex flex-col items-center pt-8">
					...
					<div className="flex pt-6 space-x-5">
						...
						<a href="https://x.com/jardarrrr" target="_blank" className="inline-flex items-center">
						...
						<a href="https://www.linkedin.com/in/dmitry-pligin/" target="_blank" className="inline-flex items-center">
